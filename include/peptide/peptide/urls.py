...
urlpatterns = [
    ...
    re_path(r'^spec_list/$', views.spec_list, name='spec_list'),
    re_path(r'^pro_list/$', views.pro_list, name='pro_list'),
    re_path(r'^func_list/$', views.func_list, name='func_list'),

    #re_path(r'^peptide', v_multi_search/$', views.peptide_multi_search, name='peptide_multi_search'),
